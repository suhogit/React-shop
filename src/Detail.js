      ...
      <div className="row">
        ...
        <div className="col-md-6 mt-4">
          ...
          <button className="btn btn-danger" onClick={ ()=>{
            ...
            history.push('/cart'); // 원래 개발단계에서 미리보기 띄울때 페이지 이동하면 초기화됨 (사이트 발행하면 제대로 작동한다함) 그래서 라우터 함수를 이용해 강제 이동시킴 그럼 초기화X
...
export default connect(state를props화)(Detail) //props.dispatch를 그냥 쓰면 에러남 connect 꼭해주기 import까지
